  ...
  return (
    ...
    >
      ...
      <a
        ...
        className="inline-flex items-center gap-2 bg-[#F26522] hover:bg-[#D95A1A] text-white font-semibold px-6 py-3.5 rounded-xl transition-colors duration-200 text-sm"
      >
      ...
      <p className="text-xs text-gray-400 mt-6">
        Only serious applicants will be admitted.
      </p>
    </motion.div>
  )
}
